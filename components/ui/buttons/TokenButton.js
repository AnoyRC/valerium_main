...
import { setDrawerChain, setTokenIndex, toggleTokenDrawer } from "@/redux/slice/selectorSlice";
    ...
    >
      ...
      >
        ...
        <Button
            ...
            disabled={disabled}
            className="w-full normal-case font-noto text-left rounded-full border border-border-light shadow-none bg-white px-5 py-3.5 text-base text-gray-600 outline-none"
        >
            {token[index] ? <div>
